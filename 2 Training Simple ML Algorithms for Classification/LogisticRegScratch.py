...
class LogisticRegression(object):
	...
	1.Learning rate
	2.Epochs
	3.Random State(optional) It is only used for reproducing same results.
	'''
...
if __name__=='__main__':
	...
	LogisticRegression=LogisticRegression(learning_rate=0.001 , epochs=50 , random_state=69)
	...
	print('Predicted Label for Testing data: '  ,LogisticRegression.predict(X_test,threshold=0.6 ))
